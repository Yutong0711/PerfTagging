...
public class OakImpalaRules {
	public static List<Sentence> checkRules(List<Sentence> sentences) {
		...
		for (Sentence sentence : sentences) {
			...
			if (OakImpalaRules.gk1_efficiency(sentence)) {
				numbers.add(101);
				names.add("gk1_efficiency");
			}
			if (OakImpalaRules.gk2_complexity(sentence)) {
				numbers.add(102);
				names.add("gk2_complexity");
			}
			if (OakImpalaRules.gk3_reduce(sentence)) {
				numbers.add(103);
				names.add("gk3_reduce");
			}
			if (OakImpalaRules.gk4_performance(sentence)) {
				numbers.add(104);
				names.add("gk4_performance");
			}
			if (OakImpalaRules.gk5_latency(sentence)) {
				numbers.add(105);
				names.add("gk5_latency");
			}
			if (OakImpalaRules.gk6_expensive(sentence)) {
				numbers.add(106);
				names.add("gk6_expensive");
			}
			if (OakImpalaRules.gk7_speed(sentence)) {
				numbers.add(107);
				names.add("gk7_speed");
			}
			if (OakImpalaRules.gk8_spilling(sentence)) {
				numbers.add(108);
				names.add("gk8_spilling");
			}
			if (OakImpalaRules.sk1_negative_necessary(sentence)) {
				numbers.add(201);
				names.add("sk1_negative_necessary");
			}
			if (OakImpalaRules.sk2_block_hang_crash(sentence)) {
				numbers.add(202);
				names.add("sk2_block_hang_crash");
			}
			if (OakImpalaRules.sk3_byte(sentence)) {
				numbers.add(203);
				names.add("sk3_byte");
			}
			if (OakImpalaRules.sk4_prefetch(sentence)) {
				numbers.add(204);
				names.add("sk4_prefetch");
			}
			if (OakImpalaRules.sk5_hotspot(sentence)) {
				numbers.add(205);
				names.add("sk5_hotspot");
			}
			if (OakImpalaRules.sk6_enough_space(sentence)) {
				numbers.add(206);
				names.add("sk6_enough_space");
			}
			if (OakImpalaRules.sk7_buffer(sentence)) {
				numbers.add(207);
				names.add("sk7_buffer");
			}
			if (OakImpalaRules.sk8_timeout_expiration(sentence)) {
				numbers.add(208);
				names.add("sk8_timeout_expiration");
			}
			if (OakImpalaRules.sk9_frequency(sentence)) {
				numbers.add(209);
				names.add("sk9_frequency");
			}
			if (OakImpalaRules.sk10_skip(sentence)) {
				numbers.add(210);
				names.add("sk10_skip");
			}
			if (OakImpalaRules.sk11_infinity(sentence)) {
				numbers.add(211);
				names.add("sk11_infinity");
			}
			if (OakImpalaRules.sk12_over_again(sentence)) {
				numbers.add(212);
				names.add("sk12_over_again");
			}
			if (OakImpalaRules.sk13_regression(sentence)) {
				numbers.add(213);
				names.add("sk13_regression");
			}
			if (OakImpalaRules.sk14_overhead(sentence)) {
				numbers.add(214);
				names.add("sk14_overhead");
			}
			if (OakImpalaRules.tk1_contended_lock(sentence)) {
				numbers.add(301);
				names.add("tk1_contended_lock");
			}
			if (OakImpalaRules.tk2_bound(sentence)) {
				numbers.add(302);
				names.add("tk2_bound");
			}
			if (OakImpalaRules.tk3_memory_unit(sentence)) {
				numbers.add(303);
				names.add("tk3_memory_unit");
			}
			if (OakImpalaRules.tk4_cpi(sentence)) {
				numbers.add(304);
				names.add("tk4_cpi");
			}
			if (OakImpalaRules.tk5_execution_skew(sentence)) {
				numbers.add(305);
				names.add("tk5_execution_skew");
			}
			if (OakImpalaRules.tk6_iteration(sentence)) {
				numbers.add(306);
				names.add("tk6_iteration");
			}
			if (OakImpalaRules.tk7_concurrent(sentence)) {
				numbers.add(307);
				names.add("tk7_concurrent");
			}
			if (OakImpalaRules.tk8_probe_filter(sentence)) {
				numbers.add(308);
				names.add("tk8_probe_filter");
			}

			if (OakImpalaRules.pf1_percentage(sentence)) {
				numbers.add(401);
				names.add("pf1_percentage");
			}
			if (OakImpalaRules.pf2_duration(sentence)) {
				numbers.add(402);
				names.add("pf2_duration");
			}
			if (OakImpalaRules.pf3_profiling(sentence)) {
				numbers.add(403);
				names.add("pf3_profiling");
			}
			if (OakImpalaRules.pf4_benchmark(sentence)) {
				numbers.add(404);
				names.add("pf4_benchmark");
			}
			if (OakImpalaRules.ss1_one_per(sentence)) {
				numbers.add(501);
				names.add("ss1_one_per");
			}
			if (OakImpalaRules.ss2_all_to_one(sentence)) {
				numbers.add(502);
				names.add("ss2_all_to_one");
			}
			if (OakImpalaRules.ss3_in_one_go(sentence)) {
				numbers.add(503);
				names.add("ss3_in_one_go");
			}
			if (OakImpalaRules.ss4_memory(sentence)) {
				numbers.add(504);
				names.add("ss4_memory");
			}
			if (OakImpalaRules.ss5_cpu(sentence)) {
				numbers.add(505);
				names.add("ss5_cpu");
			}
			if (OakImpalaRules.ss6_per_per(sentence)) {
				numbers.add(506);
				names.add("ss6_per_per");
			}
			if (OakImpalaRules.ss7_nn_by_nn(sentence)) {
				numbers.add(507);
				names.add("ss7_nn_by_nn");
			}
			if (OakImpalaRules.ss8_load_nn(sentence)) {
				numbers.add(508);
				names.add("ss8_load_nn");
			}
			if (OakImpalaRules.ss9_respond_until(sentence)) {
				numbers.add(509);
				names.add("ss9_respond_until");
			}
			if (OakImpalaRules.ss10_called_frequently(sentence)) {
				numbers.add(510);
				names.add("ss10_called_frequently");
			}
			if (OakImpalaRules.ss11_rework(sentence)) {
				numbers.add(511);
				names.add("ss11_rework");
			}
			if (OakImpalaRules.ss12_spend_time(sentence)) {
				numbers.add(512);
				names.add("ss12_spend_time");
			}
			if (OakImpalaRules.ss13_cache(sentence)) {
				numbers.add(513);
				names.add("ss13_cache");
			}
			if (OakImpalaRules.ss14_perform(sentence)) {
				numbers.add(514);
				names.add("ss14_perform");
			}
			if (OakImpalaRules.ss15_each_one(sentence)) {
				numbers.add(515);
				names.add("ss15_each_one");
			}
			if (OakImpalaRules.ss16_close_immediately(sentence)) {
				numbers.add(516);
				names.add("ss16_close_immediately");
			}
			if (OakImpalaRules.ss17_cardinality_cost(sentence)) {
				numbers.add(517);
				names.add("ss17_cardinality_cost");
			}
			if (OakImpalaRules.ss18_fast_to(sentence)) {
				numbers.add(518);
				names.add("ss18_fast_to");
			}
			if (OakImpalaRules.ss19_lot_reading(sentence)) {
				numbers.add(519);
				names.add("ss19_lot_reading");
			}
			if (OakImpalaRules.ss20_roundtrip(sentence)) {
				numbers.add(520);
				names.add("ss20_roundtrip");
			}
			if (OakImpalaRules.ss21_traversal(sentence)) {
				numbers.add(521);
				names.add("ss21_traversal");
			}
			if (OakImpalaRules.ss22_cd_files(sentence)) {
				numbers.add(522);
				names.add("ss22_cd_files");
			}
			if (OakImpalaRules.ss23_avoid_if(sentence)) {
				numbers.add(523);
				names.add("ss23_avoid_if");
			}
			if (OakImpalaRules.ss24_cost(sentence)) {
				numbers.add(524);
				names.add("ss24_cost");
			}
			if (OakImpalaRules.ss25_sessions(sentence)) {
				numbers.add(525);
